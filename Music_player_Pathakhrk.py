...
def help():
    webbrowser.open("https://join.skype.com/invite/xbhKyq5ahz4v")

def contact():
    webbrowser.open("https://join.skype.com/invite/xbhKyq5ahz4v")

def contribute():
    webbrowser.open("https://github.com/Pathakhrkcu/Music_player_Python_by_Pathak.tech")
...
one.pack(fill=X)
two = Label(root, text="Pathak Music player", bg="red",fg="white")
two.pack(fill=X)
three = Label(root, text="Devloper Raj Kumar", bg="light yellow",fg="blue")
three.pack(fill=X)
...
root.screenMessage.set("Pathak.tech")
